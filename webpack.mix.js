...
mix.js('resources/js/app.js', 'public/js')
    ...
    .js('resources/js/quality-manager-application.js', 'public/js')
    .js('resources/js/administration-associate-application.js', 'public/js')
    .js('resources/js/jps-application.js', 'public/js')
