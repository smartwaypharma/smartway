...
use App\Mail\UnlicensedMedicinesExecutiveNotification;
...
class WhoWeAreController extends Controller
{
    ...
    public function UnlicensedMedicinesExecutive()
    {
        return view('front.pages.who-we-are.unlicensed-medicines-executive');
    }
    ...
    public function BilingualCustomerServiceRepresentativeSubmit(Request $request)
    {
        ...
        Mail::to([
            ['email' => 'recruitment@smartwaypharma.com']
        ])
    ...
    public function UnlicensedMedicinesExecutiveFormSubmit(Request $request)
    {
        $request->validate([
            'name' => 'required',
            'organisation' => 'required',
        ...
        Mail::to([
            ['email' => 'amit.shah@smartwaypharma.com']
        ])
            ->send(new UnlicensedMedicinesExecutiveNotification($request->all()));
    ...
    public function UnlicensedMedicinesExecutiveUploadFile(Request $request)
    {
        if ($request->hasFile('file')) {
            $file = $request->file('file')->store('unlicense-medicines-exceutive-files', 'public');
        }
