...
use App\Mail\INDApplicationNotification;
...
class WhoWeAreController extends Controller
{
    ...
    public function UKAdminAssociateApplication()
    {
        return view('front.pages.who-we-are.uk-admin-associate-application');
    }

    public function INDAdminAssociateApplication()
    {
        return view('front.pages.who-we-are.ind-admin-associate-application');
    }
    ...
    public function UKAdminAssociateApplicationFormSubmit(Request $request)
    {
        $request->validate([
            'name' => 'required',
            'organisation' => 'required',
    ...
    public function UKAdminAssociateUploadFile(Request $request)
    {
        if ($request->hasFile('file')) {
            $file = $request->file('file')->store('uk-admin-application-files', 'public');
        }

        return response()->json(['url' => $file]);
    }

    public function INDAdminAssociateApplicationFormSubmit(Request $request)
    {
        $request->validate([
            'name' => 'required',
            'organisation' => 'required',
        ...
        Mail::to([
            ...
            ->send(new INDApplicationNotification($request->all()));
    ...
    public function INDAdminAssociateUploadFile(Request $request)
    {
        if ($request->hasFile('file')) {
            $file = $request->file('file')->store('ind-application-files', 'public');
        }
