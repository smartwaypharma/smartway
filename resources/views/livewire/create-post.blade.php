        ...
        <form wire:submit.prevent="save">
          ...
          <div class="my-3">
            <div wire:ignore>
              ...
              <textarea class="form-control" id="post_body" wire:model="post_body"></textarea>
            </div>
          ...
          <div class="my-3">
            <div wire:ignore>
              ...
              <textarea class="form-control" id="text_under_pdf" wire:model="text_under_pdf"></textarea>
            </div>
