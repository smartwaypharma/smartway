        ...
        <form wire:submit.prevent="save">
          ...
          <div class="my-3">
            <div wire:ignore>
              ...
              <textarea class="form-control" id="post-body" wire:key="ckeditor-post-body"></textarea>
            </div>
          ...
          <div class="my-3">
            <div wire:ignore>
              ...
              <textarea class="form-control" id="text-under-pdf" wire:key="ckeditor-text-under-pdf"></textarea>
            </div>
          ...
          <div class="my-6 flex">
            ...
            <div class="w-1/2 ml-2">
              <div class="my-3">
                <label for="hero_image_for_desktop" class="block font-medium text-sm text-gray-700">Team member
                  image</label>
