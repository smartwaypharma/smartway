          ...
          {{--  <div class="hours-info w-full relative z-999999 mt-12 mr-5">
            ...
            <div class="">
              <div class="flex flex-wrap lg:text-xl text-lg">
                <p class="mb-1" style="width: 43.33%;">Fri 19th December: </p>
                <p class="flex-1 mb-1 font-semibold">Normal Service</p>
              </div>
              <div class="flex flex-wrap lg:text-xl text-lg">
                <p class="mb-1" style="width: 43.33%;">Sat 20th December: </p>
                <p class="flex-1 mb-1 font-semibold">Normal Service (Last collections 1pm GMT for Royal Mail & Parcel Force. All other couriers - No service)</p>
              </div>
              <div class="flex flex-wrap lg:text-xl text-lg">
                <p class="mb-1" style="width: 43.33%;">Sun 21st December: </p>
                <p class="flex-1 mb-1 font-semibold">Closed</p>
              </div>
              <div class="flex flex-wrap lg:text-xl text-lg">
                <p class="mb-1" style="width: 43.33%;">Mon 22nd December: </p>
                <p class="flex-1 mb-1 font-semibold">Normal Service</p>
              </div>
              <div class="flex flex-wrap lg:text-xl text-lg">
                <p class="mb-1" style="width: 43.33%;">Tue 23rd December: </p>
                <p class="flex-1 mb-1 font-semibold">Normal Service</p>
              </div>
              <div class="flex flex-wrap lg:text-xl text-lg">
                <p class="mb-1" style="width: 43.33%;">Wed 24th December: </p>
                <p class="flex-1 mb-1 font-semibold">Last orders 12pm, last collection 1pm GMT</p>
              </div>
              <div class="flex flex-wrap lg:text-xl text-lg">
                <p class="mb-1" style="width: 43.33%;">Thu 25th to Sun 28th December: </p>
                <p class="flex-1 mb-1 font-semibold">Closed</p>
              </div>
              <div class="flex flex-wrap lg:text-xl text-lg">
                <p class="mb-1" style="width: 43.33%;">Mon 29th December: </p>
                <p class="flex-1 mb-1 font-semibold">Normal Service</p>
              </div>
              <div class="flex flex-wrap lg:text-xl text-lg">
                <p class="mb-1" style="width: 43.33%;">Tue 30th December: </p>
                <p class="flex-1 mb-1 font-semibold">Normal Service</p>
              </div>
              <div class="flex flex-wrap lg:text-xl text-lg">
                <p class="mb-1" style="width: 43.33%;">Wed 31st December: </p>
                <p class="flex-1 mb-1 font-semibold">Last orders 12pm, last collection 1pm GMT</p>
              </div>
              <div class="flex flex-wrap lg:text-xl text-lg">
                <p class="mb-1" style="width: 43.33%;">Thu 1st January: </p>
                <p class="flex-1 mb-1 font-semibold">Closed</p>
              </div>
              <div class="flex flex-wrap lg:text-xl text-lg">
                <p class="mb-1" style="width: 43.33%;">Fri 2nd January: </p>
                <p class="flex-1 mb-1 font-semibold">Normal Service</p>
              </div>
            </div>
