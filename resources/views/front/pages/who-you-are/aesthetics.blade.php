...
@section('content')
  <section class="container 3xl:max-w-3xl px-4 lg:mt-20 mt-8">
    ...
    <h2 class="quarto-font 4xl:text-93px xl:text-44px text-34px 4xl:leading-102px xl:leading-48px leading-40px sm:mb-12 mb-6">
      Specialising in the supply of Dermal fillers and skincare in an efficient and quality driven manner. We offer a
    ...
    <div class="4xl:text-2xl sm:text-xl text-lg 4xl:leading-37px leading-24px lg:mt-16 mt-6">
      <p class="lg:pr-0 pr-10">
        Join Smartway Aesthetic Suppliers here and discover why healthcare professionals in the UK trust us as
        their supply chain partner.
      </p>
      <p class="lg:mt-16 mt-7 lg:pr-0 pr-3">
        Once you have registered with our pharmacy, you will be able to login to your online account and view
        our full product range, with immediate access to the best deals on aesthetics products and more.
        Alternatively, speak with a member of our pharmacy team today on +44 (0)208 545 7731 to discuss the full
        range of products and services available to you and your clinic.
      </p>
    </div>
      ...
      <div class="lg:pr-20">
        <div>
          ...
          <p class="4xl:text-2xl sm:text-xl text-lg 4xl:leading-37px leading-24px">
            Our e-prescribing software is a digital platform which enables prescribers to electronically
            prescribe and transmit a prescription to our online pharmacy. We are registered with the General
            Pharmaceutical Council. The medication can be sent direct to a patient or to <span class="sm:inline block"> your clinic.</span>
          </p>
        </div>
      </div>
    ...
    <div class="4xl:text-2xl sm:text-xl text-lg 4xl:leading-37px leading-24px lg:mt-20 mt-6">
      <p class="lg:pr-0 pr-2">
        ...
        authorize, saving vital clinic time for
        your patients.
      </p>
    ...
    <div class="text-center lg:my-40 mt-16 mb-20">
      <a href="https://www.smartwayas.co.uk/my-account/"
         class="button 4xl:text-28px lg:text-xl text-2xl font-semibold bg-persian-green text-white rounded-full 4xl:py-5 py-3 4xl:px-20 px-10 block sm:inline-block">Register/Login</a>
    </div>
  </section>
@endsection
