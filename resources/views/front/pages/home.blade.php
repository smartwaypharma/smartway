      ...
      <div class="sm:w-full sm:max-w-lg h-full flex flex-col items-center justify-center p-4 sm:p-4 mx-auto">
        <div class="relative transform overflow-hidden rounded-3xl text-center shadow-xl transition-all w-full bg-lochmara border-2">
          <div class="text-center mt-3 ml-3 mr-3 mb-3">
            <h1 class="text-21px font-semibold text-white" id="modal-title">Are you going to Arab Health <br/> this January?</h1>
            <div class="mt-3">
          ...
          <div class="sm:px-6 flex items-center justify-center ml-3 mr-3 mb-5">
            <a type="button" href="https://calendly.com/smartway-commercial/smartway-arabhealth25?month=2025-01" target="_blank" class="bg-persian-green text-white rounded-3xl border-2 py-2 px-4 text-xs font-bold mr-2">Book a meeting via Calendly</a>
