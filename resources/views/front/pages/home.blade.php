      ...
      <div class="sm:w-full sm:max-w-lg h-full flex flex-col items-center justify-center p-4 sm:p-4 mx-auto">
        <div class="relative transform overflow-hidden rounded-3xl text-center shadow-xl transition-all w-full bg-lochmara border-2">
          <div class="text-center mt-3 ml-3 mr-3 mb-3">
            <h1 class="text-21px font-semibold text-white" id="modal-title">Are you going to WHX Dubai <br/> this February?</h1>
            <div class="mt-3">
              <p class="text-sm text-white font-medium mb-2">You can book a one-to-one meeting with our commercial team to explore how we can collaborate and build a profitable partnership that benefits both businesses.</p>
              <p class="text-sm text-white font-medium">Stand No: S9.A99 | 9-12 February 2026 | Dubai Exhibition Centre</p>
            </div>
          </div>
          <div class="sm:px-6 flex items-center justify-center ml-3 mr-3 mb-4">
            <a type="button" href="https://outlook.office.com/book/WHXDubai2026@smartwaypharma.co.uk/?ismsaljsauthenabled" target="_blank" class="bg-persian-green text-white rounded-3xl border-2 py-2 px-4 text-xs font-bold mr-2">Book a meeting with us</a>
