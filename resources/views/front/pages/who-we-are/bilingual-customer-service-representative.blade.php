...
@section('meta')
    <title>Who we are - Careers & Internships - Bilingual Customer Service Representative</title>
@endsection

@section('header-content')
    <img class="hidden sm:inline-block w-full" src="{{ asset('image/bilingual.jpg') }}">
    <img class="sm:hidden inline-block w-full" src="{{ asset('image/bilingual-mobile.jpg') }}">
        ...
        <div class="lg:flex">
            <div class="lg:w-7/12 lg:pr-16 ">
                <h2 class="quarto-font 4xl:text-93px xl:text-62px lg:text-44px text-34px 4xl:leading-102px xl:leading-70px lg:leading-48px leading-40px lg:mb-12 mb-6 lg:pr-0 pr-3">
                    Become our <br> Bilingual Customer Service Representative (English & Italian) - Secondary Care
                </h2>
                <div class="4xl:text-2xl sm:text-xl text-lg 4xl:leading-37px leading-24px">
                    ...
                    <p class="lg:mb-9 mb-6 lg:pr-0 pr-4">As part of Smartway's continued business expansion strategy, we are recruiting for a Bilingual Customer Service Representative to serve as "front of house" for existing markets as well as new market penetration activities within Secondary Care.</p>
                    <p class="lg:mb-9 mb-6 lg:pr-0 pr-4">This exciting role reports directly to the Global Sales Director and comprises customer interaction and administrative customer management duties.</p>
                    <p class="lg:mb-9 mb-6 lg:pr-0 pr-4">The ideal candidate will be fluent in English and Italian to native language level and have the right to work in the UK. They will be experienced in similar roles, naturally empathetic and have excellent attention to detail. </p>
                    <p class="lg:mb-9 mb-6 lg:pr-0 pr-4">Previous exposure and knowledge of the Life Sciences environment are preferred but not mandatory as full and continuous training will be provided.</p>
                    <p class="lg:mb-4 mb-2 lg:pr-0 pr-4 bold">The role comprises, but is not limited to:  </p>
                    <div class="2xl:max-w-6xl xl:max-w-4xl 2xl:pl-0 xl:pl-0 post-content xl:pr-0">
                        <ul>
                            <li class="pt-1">Handle phone and email general enquiries
                                <ul class="mt-3">
                                    <li class="pt-1">In line with company customer relationship policies</li>
                                    <li class="pt-1">Identify cross selling opportunities</li>
                            ...
                            <li class="pt-1">Process and follow orders
                                <ul class="mt-3">
                                    <li class="pt-1">Process customers' orders</li>
                                    <li class="pt-1">Follow customers' orders until delivery</li>
                                    <li class="pt-1">Monitor staggered deliveries</li>
                                </ul>
                            </li>
                            <li class="pt-1">Update and maintain CRM data
                                <ul class="mt-3">
                                    <li class="pt-1">Gather, input and manage CRM data in line with the company's procedures</li>
                                </ul>
                            </li>
                            <li class="pt-1">General administration duties
                                <ul class="mt-3">
                                    <li class="pt-1">Assist Import License application process</li>
                                    <li class="pt-1">Assist in general office admin duties</li>
                                </ul>
                            </li>
                            <li class="pt-1">Reporting to the Global Sales Director</li>
                        </ul>
                    </div>
                </div>
            ...
            <div>
                <form action="{{ route('who-we-are.bilingual-customer-service-representative-form.submit') }}" method="POST" id="contactForm" class="lg:max-w-xl mx-auto lg:px-4">
                    @csrf
