...
@section('meta')
    <title>Who we are - Careers & Internships - Unlicensed Medicines Executive</title>
@endsection

@section('header-content')
    <img class="hidden sm:inline-block w-full" src="{{ asset('image/RP_Job_Img.jpg') }}">
    <img class="sm:hidden inline-block w-full" src="{{ asset('image/RP_Job_Mobile.jpg') }}">
        ...
        <div class="lg:flex">
            <div class="lg:w-7/12 lg:pr-16 ">
                <h2 class="quarto-font 4xl:text-93px xl:text-62px lg:text-44px text-34px 4xl:leading-102px xl:leading-70px lg:leading-48px leading-40px lg:mb-12 mb-6 lg:pr-0 pr-3">
                    Become our <br> Unlicensed Medicines Executive
                </h2>
                <div class="4xl:text-2xl sm:text-xl text-lg 4xl:leading-37px leading-24px">
                    <p class="lg:mb-9 mb-6"><b>Location:</b> London office (hybrid)</p>
                    <p class="lg:mb-9 mb-6"><b>Application deadline:</b> 15th March 2024</p>
                    <h2 class="quarto-font 4xl:text-93px xl:text-62px lg:text-44px text-34px 4xl:leading-102px xl:leading-70px lg:leading-48px leading-40px lg:mb-12 mb-6 lg:pr-0 pr-3">
                        Job description
                    </h2>
                    <p class="lg:mb-9 mb-6 lg:pr-0 pr-4">The Unlicensed Medicines Executive will be responsible for supporting the department managers in procuring and selling unlicensed medicines across primary and secondary care sectors.</p>
                    <p class="lg:mb-4 mb-2 lg:pr-0 pr-4 bold"><b>Duties and responsibilities:</b></p>
                    <div class="2xl:max-w-6xl xl:max-w-4xl 2xl:pl-0 xl:pl-0 post-content xl:pr-0">
                        <ul>
                            <li>Actively making outbound contact with healthcare professionals to grow the unlicensed business;</li>
                            <li>Conducting regular meetings with key stakeholders;</li>
                            <li>Supporting in processing sales and purchase orders;</li>
                            <li>Liaising with suppliers to source and purchase unlicensed medicines;</li>
                            <li>Developing relationships with suppliers and customers;</li>
                            <li>Analysis and review of commercial accounts as part of the wider business strategy;</li>
                            <li>Communicating with other areas of the business to maximise efficiencies;</li>
                            <li>Liaising with regulatory authorities;</li>
                            <li>Representing the company at conferences and trade shows;</li>
                            <li>Some travel will be required.</li>
                        </ul>
                    </div>
                    <p class="lg:mb-4 mb-2 lg:pr-0 pr-4 bold"><b>Attributes:</b></p>
                    <div class="2xl:max-w-6xl xl:max-w-4xl 2xl:pl-0 xl:pl-0 post-content xl:pr-0">
                        <ul>
                            <li>Willingness to learn new skills and understand the industry in detail;</li>
                            <li>Attention to detail;</li>
                            <li>Ability to work in high pressure situations;</li>
                            <li>Proactive attitude;</li>
                            <li>Capable of working solely and as part of a team;</li>
                            <li>Can organise and prioritise work related tasks;</li>
                            <li>Can work effectively towards a set deadline.</li>
                        </ul>
                    </div>
                    <p class="lg:mb-9 mb-6 lg:pr-0 pr-4">The ideal candidate should have some sales or purchasing experience, not necessarily related to unlicensed medicines but within the pharmacy/pharmaceutical industry.</p>
                    <p class="lg:mb-9 mb-6"><b>Experience required:</b> 1-year minimum</p>
                    <p class="lg:mb-9 mb-6"><b>Reporting to:</b> Director of International Procurement</p>
                </div>
                <hr class="h-0.1 mt-8 mb-3 bg-black lg:hidden">
            </div>
            <div>
                <form action="{{ route('who-we-are.unlicensed-medicines-executive-form.submit') }}" method="POST" id="contactForm" class="lg:max-w-xl mx-auto lg:px-4">
                    @csrf
...
@push('scripts')
<script src="{{ mix('js/ume-application.js') }}" defer></script>
@endpush
