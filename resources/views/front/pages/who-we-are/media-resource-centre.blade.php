    ...
    <div class="xl:grid grid-cols-2">
      ...
      <div class="bg-persian-green text-center xl:py-6 pt-8 pb-10 px-6">
        <h3 class="quarto-font text-white 4xl:text-82px xl:text-54px lg:text-54px text-40px leading-none">Smartway
          Webinars</h3>
        <p class="text-white font-bold 4xl:text-2xl sm:text-xl text-lg 4xl:leading-37px leading-24px lg:px-24 px-6 lg:mt-4 mt-1">
            EAP’s a vital component of both launch and long term development and commercial strategy for Orphan and
