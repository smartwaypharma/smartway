...
@section('meta')
    <title>Who we are - Careers & Internships - Administration Associate Application</title>
@endsection

@section('header-content')
    <img class="hidden sm:inline-block w-full" src="{{ asset('image/administration.jpg') }}">
        ...
        <div class="lg:flex">
            <div class="lg:w-7/12 lg:pr-16 ">
                <h2 class="quarto-font 4xl:text-93px xl:text-62px lg:text-44px text-34px 4xl:leading-102px xl:leading-70px lg:leading-48px leading-40px lg:mb-12 mb-6 lg:pr-0 pr-3">
                    Become our <br> Administration Associate
                </h2>
                <div class="4xl:text-2xl sm:text-xl text-lg 4xl:leading-37px leading-24px">
                    ...
                    <p class="lg:mb-9 mb-6 lg:pr-0 pr-4">We are looking for an <b>Administration Associate</b> to handle day-to-day tasks alongside our regulatory department.</p>
                    ...
                    <div class="2xl:max-w-6xl xl:max-w-4xl 2xl:pl-0 xl:pl-0 post-content xl:pr-0">
                        <ul>
                            ...
                            <li>Printing documents for review by the regulatory team</li>
                            <li>Proficiency in MS Office and MS Teams is desirable </li>
                        </ul>
                    </div>
            ...
            <div>
                <form action="{{ route('who-we-are.administration-associate-application-form.submit') }}" method="POST" id="contactForm" class="lg:max-w-xl mx-auto lg:px-4">
                    @csrf
...
@push('scripts')
<script src="{{ mix('js/administration-associate-application.js') }}" defer></script>
@endpush
