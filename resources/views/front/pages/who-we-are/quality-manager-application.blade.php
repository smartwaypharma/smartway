...
@section('meta')
  <title>Who we are - Careers & Internships - Quality Manager Application</title>
@endsection

@section('header-content')
  <img class="hidden sm:inline-block w-full" src="{{ asset('image/Quality_Manager.jpg') }}">
    ...
    <div class="lg:flex">
      <div class="lg:w-7/12 lg:pr-16 ">
        <h2 class="quarto-font 4xl:text-93px xl:text-62px lg:text-44px text-34px 4xl:leading-102px xl:leading-70px lg:leading-48px leading-40px lg:mb-12 mb-6 lg:pr-0 pr-3">
            Become our <br> Quality Manager
        </h2>
        <div class="4xl:text-2xl sm:text-xl text-lg 4xl:leading-37px leading-24px">
          <p class="lg:mb-9 mb-6">
              <b>Location:</b> London office</p>
          <p class="lg:mb-9 mb-6 lg:pr-0 pr-4"><b>Application deadline:</b> 12:00am, 27th May 2022 BST</p>
          <h2 class="quarto-font 4xl:text-93px xl:text-62px lg:text-44px text-34px 4xl:leading-102px xl:leading-70px lg:leading-48px leading-40px lg:mb-12 mb-6 lg:pr-0 pr-3">
                Job description
          </h2>
          <p class="lg:mb-9 mb-6 lg:pr-0 pr-4">We are looking for a <b>Quality Assurance Manager</b> to help facilitate continuous improvement through handling the management reviews, internal audits, third parties and product recalls alongside our regulatory department.</p>
          <p class="lg:mb-9 mb-6 lg:pr-0 pr-4">All candidates must be:</p>
          <div class="2xl:max-w-6xl xl:max-w-4xl 2xl:pl-0 xl:pl-0 post-content xl:pr-0">
            <ul>
                <li>Assertive</li>
                <li>Able to prioritise tasks in accordance with deadlines </li>
                <li>Able to work autonomously and provide reports to the Head of Regulatory as required</li>
            </ul>
          </div>
          <p class="lg:mb-9 mb-6 lg:pr-0 pr-4">An example of tasks includes:</p>
          <div class="2xl:max-w-6xl xl:max-w-4xl 2xl:pl-0 xl:pl-0 post-content xl:pr-0">
                <ul>
                    <li>Handling recalls, ensuring they are actioned within a specific time frame</li>
                    <li>Completing management reviews and internal audits in accordance with a written schedule</li>
                    <li>Escalating issues to the Head of Regulatory as required</li>
                    <li>Working alongside the Regulatory Manager to facilitate continuous improvement, ensuring procedures are updated and maintained</li>
                    <li>Delivering training material for the wider business and completing competency assessments</li>
                    <li>Approving accounts on behalf of the Responsible Person for UK + EU customers</li>
                </ul>
          </div>
          <p class="lg:mb-9 mb-6 lg:pr-0 pr-4">Experience will be assessed on an individual basis. Must have    demonstrable experience and excellent English.</p>
          <p class="lg:mb-9 mb-6 lg:pr-0 pr-4">The role reports directly to the Head of Regulatory.</p>
        </div>
        <hr class="h-0.1 mt-8 mb-3 bg-black lg:hidden">
      </div>
        <div>
            <form action="{{ route('who-we-are.quality-manager-application-form.submit') }}" method="POST" id="contactForm" class="lg:max-w-xl mx-auto lg:px-4">
                @csrf
...
@push('scripts')
  <script src="{{ mix('js/quality-manager-application.js') }}" defer></script>
@endpush
