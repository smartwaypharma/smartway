...
@section('content')
  <section class="container 3xl:max-w-3xl px-4 lg:mt-40 mt-20">
    ...
    <h2 class="4xl:text-32px xl:text-2xl text-22px 4xl:leading-37px leading-28px font-bold lg:mb-14 mb-6">We’re
      dedicated to empowering that access to
      medicines.</h2>
    ...
    <div class="lg:grid grid-cols-2 gap-12 lg:mt-14 mt-6">
      <div class="flex items-center lg:pr-10">
        <div>
          <h2 class="4xl:text-32px xl:text-2xl text-22px 4xl:leading-37px leading-28px font-bold lg:mb-14">End-to-end
            solutions for Aid Dev</h2>
          ...
          <div class="4xl:text-2xl sm:text-xl text-lg 4xl:leading-37px leading-24px">
            ...
            <p class="font-bold lg:text-2xl text-22px lg:pr-14">
  ...
  <section class="container 3xl:max-w-3xl px-4">
    <p class="4xl:text-32px xl:text-2xl text-22px 4xl:leading-37px leading-28px font-bold text-center">Why partner with
      Smartway?</p>
    <div class="xl:grid hidden grid-cols-5 gap-6 lg:mt-16 mt-7 4xl:text-22px text-lg pb-4 xl:px-0 px-6">
      <div class="bg-alabaster rounded-10px card-box-shadow text-center pt-10 lg:pb-20 pb-16 px-2">
        <img class="circle-box-shadow w-50 h-50 rounded-full mx-auto mb-5" src="{{ asset('image/cts-icn1.svg') }}" alt="Smartway Pharmaceuticals - End-to-end supply chain management" title="Smartway Pharmaceuticals - End-to-end supply chain management"/>
      ...
      <div class="bg-alabaster rounded-10px card-box-shadow text-center pt-10 lg:pb-20 pb-16 px-2">
        <img class="circle-box-shadow w-50 h-50 rounded-full mx-auto mb-5" src="{{ asset('image/cts-icn2.svg') }}" alt="Smartway Pharmaceuticals - Global distribution / hub network" title="Smartway Pharmaceuticals - Global distribution / hub network"/>
        <p class="font-bold leading-tight mb-3">
      ...
      <div class="bg-alabaster rounded-10px card-box-shadow text-center pt-10 lg:pb-20 px-5 pb-16">
        <img class="circle-box-shadow w-50 h-50 rounded-full mx-auto mb-5"
             src="{{ asset('image/cts-icn3.svg') }}" alt="Smartway Pharmaceuticals - Aid Dev sector expertise" title="Smartway Pharmaceuticals - Aid Dev sector expertise"/>
      ...
      <div class="bg-alabaster rounded-10px card-box-shadow text-center pt-10 lg:pb-20 pb-16 px-4">
        <img class="circle-box-shadow w-50 h-50 rounded-full mx-auto mb-5" src="{{ asset('image/cts-icn5.svg') }}" alt="Smartway Pharmaceuticals - Stakeholder support" title="Smartway Pharmaceuticals - Stakeholder support"/>
        <p class="font-bold leading-tight mb-10">
          Stakeholder support
        </p>
        <p>
      ...
      <div class="bg-alabaster rounded-10px card-box-shadow text-center pt-10 lg:pb-20 pb-16 px-8">
        <img class="circle-box-shadow w-50 h-50 rounded-full mx-auto mb-5" src="{{ asset('image/cts-icn4.svg') }}" alt="Smartway Pharmaceuticals - Global procurement" title="Smartway Pharmaceuticals - Global procurement"/>
        <p class="font-bold leading-tight mb-10">
          Global procurement
        </p>
        <p>
    ...
    <div class="xl:hidden grid-cols-5 gap-6 lg:mt-16 mt-7 4xl:text-22px text-lg pb-4 xl:px-0 px-6">
        ...
        <div class="glide__track" data-glide-el="track">
          <div class="glide__slides">
            <div class="glide__slide bg-alabaster rounded-10px card-box-shadow text-center pt-10 pb-20 px-5 mr-6 my-2">
              <img class="circle-box-shadow w-50 h-50 rounded-full mx-auto mb-5"
                   src="{{ asset('image/cts-icn1.svg') }}" alt="Smartway Pharmaceuticals - End-to-end supply chain management" title="Smartway Pharmaceuticals - End-to-end supply chain management"/>
              <p class="font-bold leading-tight mb-3">
                <span class="block">End-to-end supply</span>
                <span class="block">chain management</span>
              </p>
            ...
            <div class="glide__slide bg-alabaster rounded-10px card-box-shadow text-center pt-10 pb-20 px-5 mr-6 my-2">
              <img class="circle-box-shadow w-50 h-50 rounded-full mx-auto mb-5"
                   src="{{ asset('image/cts-icn2.svg') }}" alt="Smartway Pharmaceuticals - Global distribution / hub network" title="Smartway Pharmaceuticals - Global distribution / hub network"/>
              <p class="font-bold leading-tight mb-3">
                <span class="block">Global distribution/</span>
                <span class="block">hub network</span>
              </p>
            ...
            <div class="glide__slide bg-alabaster rounded-10px card-box-shadow text-center pt-10 pb-20 px-5 mr-6 my-2">
              <img class="circle-box-shadow w-50 h-50 rounded-full mx-auto mb-5"
                   src="{{ asset('image/cts-icn5.svg') }}" alt="Smartway Pharmaceuticals - Stakeholder support" title="Smartway Pharmaceuticals - Stakeholder support"/>
              <p class="font-bold leading-tight mb-10">
                Stakeholder support
              </p>
              <p>
            ...
            <div class="glide__slide bg-alabaster rounded-10px card-box-shadow text-center pt-10 pb-20 px-5 mr-6 my-2">
              <img class="circle-box-shadow w-50 h-50 rounded-full mx-auto mb-5"
                   src="{{ asset('image/cts-icn4.svg') }}" alt="Smartway Pharmaceuticals - Global procurement" title="Smartway Pharmaceuticals - Global procurement"/>
              <p class="font-bold leading-tight mb-10">
                Global procurement
              </p>
              <p>
    ...
    <div class="text-center lg:mt-20 mt-16">
      <a href="{{ route('connect-with-us') }}"
         class="button lg:text-28px text-2xl font-semibold bg-persian-green text-white rounded-full py-14px lg:py-4 px-10 block sm:inline-block">How
        can we help?</a>
    </div>
    ...
    <div class="grid xl:grid-cols-2 grid-cols-1 lg:gap-y-40 gap-y-20">
      <div class="xl:pr-32">
        <a href="{{ route('how-we-help.aid-dev.global-procurement') }}"
           class="quarto-font lg:text-62px text-44px leading-none">Pharmaceutical, Device & Equipment Supply</a>
        <img class="xl:hidden my-7" src="{{ asset('image/iStock-1214722898.png') }}" alt="Smartway Pharmaceuticals - Pharmaceutical, Device & Equipment Supply" title="Smartway Pharmaceuticals - Pharmaceutical, Device & Equipment Supply">
        ...
        <a class="lg:text-2xl text-md font-bold flex items-center"
      ...
      <div class="xl:pl-24">
        <a href="{{ route('how-we-help.aid-dev.global-supply-chain-capability') }}"
           class="quarto-font lg:text-62px text-44px leading-none">
          <span class="4xl:block">Global Distribution &</span>
          <span class="4xl:block">Storage Network</span>
        </a>
        <img class="xl:hidden my-7" src="{{ asset('image/Global_Distribution.jpg') }}" alt="Smartway Pharmaceuticals - Global Distribution & Storage Network" title="Smartway Pharmaceuticals - Global Distribution & Storage Network">
    ...
    <div id="kitting" class="grid xl:grid-cols-2 grid-cols-1 lg:mt-40 mt-20 lg:mb-40 mb-20">
      <div class="xl:pr-28">
        <a href="{{ route('how-we-help.aid-dev.kitting') }}#kitting"
           class="quarto-font lg:text-62px text-44px leading-none">Kitting</a>
        <img class="xl:hidden my-7" src="{{ asset('image/iStock-1272685075.png') }}" alt="Smartway Pharmaceuticals - Kitting" title="Smartway Pharmaceuticals - Kitting">
        <div class="4xl:text-2xl sm:text-xl text-lg 4xl:leading-37px leading-24px mt-5 xl:mb-16 mb-9">
          <p>
        ...
        <button id="kittingButton" class="lg:text-2xl text-md font-bold flex items-center"><img
              class="inline mr-4 transform" src="{{ asset('image/icon/read_less_icn.svg') }}" alt="Smartway Pharmaceuticals - arrow icon" title="Smartway Pharmaceuticals - arrow icon"><span>Read Less</span>
        </button>
      </div>
      <div class="xl:flex hidden items-center">
    ...
    <div class="grid xl:grid-cols-2 grid-cols-1 lg:gap-y-40 gap-y-20">
      ...
      <div class="xl:pl-24">
        <a href="{{ route('how-we-help.aid-dev.experience-and-expertise') }}"
           class="quarto-font lg:text-62px text-44px leading-none sm:mr-0 -mr-4 block">Project Management</a>
        <img class="xl:hidden my-7" src="{{ asset('image/businesspeople-brainstorming-in-a-meeting-WH57EEX.png') }}" alt="Smartway Pharmaceuticals - Project Management" title="Smartway Pharmaceuticals - Project Management">
      ...
      <div class="xl:pr-24">
        <a href="{{ route('who-we-are.media-and-resource-centre.index') }}"
           class="quarto-font lg:text-62px text-44px leading-none">Resource Centre</a>
