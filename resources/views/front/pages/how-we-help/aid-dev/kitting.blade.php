  ...
  <section class="container 3xl:max-w-3xl px-4 lg:mb-40 mb-20">
    <div class="grid xl:grid-cols-2 grid-cols-1 lg:gap-y-40 gap-y-20">
      <div class="xl:pr-32">
        ...
        <img class="xl:hidden my-7" src="{{ asset('image/iStock-1214722898.png') }}">
      ...
      <div class="xl:pl-24">
        ...
        <img class="xl:hidden my-7" src="{{ asset('image/Global_Distribution.jpg') }}">
    ...
    <div id="kitting" class="grid xl:grid-cols-2 grid-cols-1 lg:mt-40 mt-20 lg:mb-40 mb-20">
      <div class="xl:pr-28">
        ...
        <img class="xl:hidden my-7" src="{{ asset('image/iStock-1272685075.png') }}">
        <div class="4xl:text-2xl sm:text-xl text-lg 4xl:leading-37px leading-24px mt-5 xl:mb-16 mb-9">
          <p>
        ...
        <button id="kittingButton" class="lg:text-2xl text-md font-bold flex items-center"><img
              class="inline mr-4 transform" src="{{ asset('image/icon/read_less_icn.svg') }}"><span>Read Less</span>
        </button>
      </div>
      <div class="xl:flex hidden items-center">
    ...
    <div class="grid xl:grid-cols-2 grid-cols-1 lg:gap-y-40 gap-y-20">
      ...
      <div class="xl:pl-24">
        ...
        <img class="xl:hidden my-7" src="{{ asset('image/businesspeople-brainstorming-in-a-meeting-WH57EEX.png') }}">
