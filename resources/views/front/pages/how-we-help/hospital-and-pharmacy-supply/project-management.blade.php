...
@section('header-content')
  <img class="hidden sm:inline-block w-full" src="{{ asset('/image/Hospital_Project_management_main.jpg') }}" alt="Smartway Pharmaceuticals - Project Management" title="Smartway Pharmaceuticals - Project Management">
  <img class="sm:hidden inline-block w-full" src="{{ asset('/image/Hospital_Project_Management_Mobile.jpg') }}" alt="Smartway Pharmaceuticals - Project Management" title="Smartway Pharmaceuticals - Project Management">
...
@section('content')
  ...
  <section class="container 3xl:max-w-3xl px-4">
    ...
    {{--<div class="grid xl:grid-cols-3 md:grid-cols-2 gap-x-5 lg:gap-y-20 gap-y-8 mt-28">
      ...
      <div class="4xl:text-2xl text-xl">
        <img class="mb-3" src="{{ asset('image/Ritesh-team.jpg') }}" alt="Smartway Pharmaceuticals - Ritesh Patel - Senior Manager – UK Specialist Supply Chain (Retail Pharmacy)" title="Smartway Pharmaceuticals - Ritesh Patel - Senior Manager – UK Specialist Supply Chain (Retail Pharmacy)">
      ...
      <div class="4xl:text-2xl text-xl">
        <img class="mb-3" src="{{ asset('image/Giles-team.jpg') }}" alt="Smartway Pharmaceuticals - Giles Holford - Head of Sexual Health Supply" title="Smartway Pharmaceuticals - Giles Holford - Head of Sexual Health Supply">
