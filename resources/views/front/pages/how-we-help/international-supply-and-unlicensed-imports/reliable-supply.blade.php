...
@section('meta')
  <title>Your Reliable Partner in the Supply of Medicines Worldwide</title>
  <meta name="description" content="We ensure reliable supply of medicines worldwide. Smartway provides both branded and generic medicines to healthcare professionals, carers and patients. We are your reliable partner, committed to sourcing and supplying medicines and healthcare products both online and offline.">
@endsection

@section('header-content')
  <img class="hidden sm:inline-block w-full" src="{{ asset('image/hero-reliable-supply.jpg') }}" alt="Smartway Pharmaceuticals - Reliable Supply of Medicines Sourced Worldwide" title="Smartway Pharmaceuticals - Reliable Supply of Medicines Sourced Worldwide">
  <img class="sm:hidden inline-block w-full" src="{{ asset('image/IS_Reliable_Supply.jpg') }}" alt="Smartway Pharmaceuticals - Reliable Supply of Medicines Sourced Worldwide" title="Smartway Pharmaceuticals - Reliable Supply of Medicines Sourced Worldwide">
...
@section('content')
  <section class="container 3xl:max-w-3xl px-4 lg:mt-20 mt-8">
    ...
    <p class="4xl:text-32px xl:text-2xl text-22px 4xl:leading-37px leading-28px font-bold lg:mb-14 mb-6">Our unrivalled supply network covers 40 countries worldwide.</p>
    ...
    <div class="lg:grid grid-cols-2">
      <div class="lg:pr-14">
        <div>
          ...
          <img class="lg:hidden sm:w-3/4 my-8" src="{{ asset('image/iStock-1164357333.png') }}" alt="Smartway Pharmaceuticals - Safeguarding quality with audited, approved suppliers" title="Smartway Pharmaceuticals - Safeguarding quality with audited, approved suppliers">
      ...
      <div class="lg:block hidden">
        <img src="{{ asset('image/iStock-1164357333.png') }}" alt="Smartway Pharmaceuticals - Safeguarding quality with audited, approved suppliers" title="Smartway Pharmaceuticals - Safeguarding quality with audited, approved suppliers">
      </div>
    </div>
    <div class="lg:grid grid-cols-2 lg:mt-36 mt-16">
      <div class="lg:block hidden">
        <img src="{{ asset('image/Relabelling.jpg') }}" alt="Smartway Pharmaceuticals - Relabelling" title="Smartway Pharmaceuticals - Relabelling">
      </div>
      <div class="lg:pl-10">
        <div>
          <h2 class="4xl:text-32px xl:text-2xl text-22px 4xl:leading-37px leading-28px lg:leading-36px leading-28px font-bold mb-6">
            Relabelling</h2>
          <img class="lg:hidden sm:w-3/4 my-8" src="{{ asset('image/Relabelling.jpg') }}" alt="Smartway Pharmaceuticals - Relabelling" title="Smartway Pharmaceuticals - Relabelling">
          <div class="4xl:text-2xl sm:text-xl text-lg 4xl:leading-37px leading-24px">
            <p class="lg:mb-10 mb-6">
