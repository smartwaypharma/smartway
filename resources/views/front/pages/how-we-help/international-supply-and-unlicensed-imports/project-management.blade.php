...
@section('header-content')
  <img class="hidden sm:inline-block w-full" src="{{ asset('/image/iStock-1187114666-header.png') }}">
  <img class="sm:hidden inline-block w-full" src="{{ asset('/image/IS_Project_Management.jpg') }}">
