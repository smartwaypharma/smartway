...
@section('header-content')
  <img class="hidden sm:inline-block w-full" src="{{ asset('/image/iStock-1127397327-header.png') }}" alt="Smartway Pharmaceuticals - Consultancy" title="Smartway Pharmaceuticals - Consultancy">
  <img class="sm:hidden inline-block w-full" src="{{ asset('/image/Consultancy.jpg') }}" alt="Smartway Pharmaceuticals - Consultancy" title="Smartway Pharmaceuticals - Consultancy">
...
@section('content')
  ...
  <section class="container 3xl:max-w-3xl px-4">
    ...
    <div class="lg:grid flex flex-col-reverse grid-cols-2 sm:mt-14 mt-7">
        ...
        <ul class="4xl:text-32px text-xl font-semibold lg:-tracking-0.8px -tracking-0.5px">
          <li class="flex lg:items-center">
            <div class="h-8 w-8 bg-persian-green rounded-full flex justify-center items-center mr-3.5">
              <img class="h-6 w-6" src="{{ asset('image/icon/Ic_check_26px.svg') }}" alt="Smartway Pharmaceuticals - check icon" title="Smartway Pharmaceuticals - check icon">
            </div>
            Launch marketing
          </li>
      ...
      <div>
        <img class="lg:w-auto sm:w-3/4" src="{{ asset('image/iStock-1015425392.png') }}" alt="Smartway Pharmaceuticals - Team experienced in" title="Smartway Pharmaceuticals - Team experienced in">
      </div>
    </div>
  ...
  <section class="container 3xl:max-w-3xl px-4">
    <div class="lg:grid grid-cols-2">
      <div>
        ...
        <img class="lg:hidden sm:w-3/4 block mt-8" src="{{asset('image/iStock-1217833715.png')}}" alt="Smartway Pharmaceuticals - Typical projects" title="Smartway Pharmaceuticals - Typical projects">
      ...
      <div class="lg:block hidden">
        <img src="{{asset('image/iStock-1217833715.png')}}" alt="Smartway Pharmaceuticals - Typical projects" title="Smartway Pharmaceuticals - Typical projects">
      </div>
    </div>
  ...
  <section class="container 3xl:max-w-3xl px-4">
    ...
    {{--<div class="grid lg:grid-cols-3 lg:gap-5 gap-20 lg:mb-14 mb-16">
      <div>
        <img class="mb-3" src="{{asset('image/Josh-team.jpg')}}" alt="Smartway Pharmaceuticals - Josh Cocklin - Chief Executive" title="Smartway Pharmaceuticals - Josh Cocklin - Chief Executive">
      ...
      <div>
        <img class="mb-3" src="{{ asset('image/Robert-team.jpg') }}" alt="Smartway Pharmaceuticals - Robert Donnell - EVP – Medicines Access" title="Smartway Pharmaceuticals - Robert Donnell - EVP – Medicines Access">
