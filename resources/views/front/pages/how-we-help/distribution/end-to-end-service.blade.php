...
@section('header-content')
  <img class="hidden sm:inline-block w-full" src="{{ asset('image/end-to-end-hero.jpg') }}">
  <img class="sm:hidden inline-block w-full" src="{{ asset('image/SD_End_Service.jpg') }}">
...
@section('content')
    ...
    <div class="lg:grid grid-cols-2">
      <div class="lg:pr-28">
        <div>
          ...
          <img class="lg:hidden sm:w-3/4 my-8" src="{{ asset('image/cash_services.jpg') }}">
      ...
      <div class="lg:block hidden">
        <img src="{{ asset('image/cash_services.jpg') }}">
      </div>
    </div>
  ...
  <section class="container 3xl:max-w-3xl px-4 lg:mt-14 mt-6">
    ...
    <div class="grid lg:grid-cols-3 gap-x-5 lg:gap-y-16 gap-y-8 lg:mt-20 mt-7">
      ...
      <div class="4xl:text-2xl text-xl">
        <img class="mb-3" src="{{ asset('image/Nicole-team.jpg') }}">
